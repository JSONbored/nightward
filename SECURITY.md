...
- Parser or provider behavior that leaks secrets, follows config symlinks into unreviewed targets, reads huge configs inline, or turns provider timeout/output-cap failures into clean results.
