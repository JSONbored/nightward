	...
	return []adapterSpec{
		{
			...
			Paths: []pathSpec{
				...
				portable("Codex", "~/.codex/mcp.json", "Codex standalone MCP config should be reviewed before syncing.", true),
				portable("Codex", "~/.codex/mcp.yaml", "Codex YAML MCP config should be reviewed before syncing.", true),
				portable("Codex", "~/.codex/mcp.yml", "Codex YAML MCP config should be reviewed before syncing.", true),
		...
		},
		{
			...
			Paths: []pathSpec{
				...
				portable("Claude", "~/.claude/mcp.json", "Claude Code MCP config should be reviewed before syncing.", true),
				portable("Claude", "~/.claude/mcp.yaml", "Claude Code YAML MCP config should be reviewed before syncing.", true),
				portable("Claude", "~/.claude/mcp.yml", "Claude Code YAML MCP config should be reviewed before syncing.", true),
		...
		},
		{
			...
			Paths: []pathSpec{
				...
				portable("Cursor", "~/.cursor/mcp.yaml", "Cursor YAML MCP config should be reviewed before syncing.", true),
				portable("Cursor", "~/.cursor/mcp.yml", "Cursor YAML MCP config should be reviewed before syncing.", true),
				...
				portable("Cursor", "~/Library/Application Support/Cursor/User/mcp.yaml", "Cursor user YAML MCP config should be reviewed before syncing.", true),
				portable("Cursor", "~/Library/Application Support/Cursor/User/mcp.yml", "Cursor user YAML MCP config should be reviewed before syncing.", true),
			},
		},
		{
			Name:        "Windsurf",
			...
			Paths: []pathSpec{
				...
				portable("Windsurf", "~/.windsurf/mcp.yaml", "Windsurf YAML MCP config should be reviewed before syncing.", true),
				portable("Windsurf", "~/.windsurf/mcp.yml", "Windsurf YAML MCP config should be reviewed before syncing.", true),
				...
				portable("Windsurf", "~/Library/Application Support/Windsurf/User/mcp.yaml", "Windsurf user YAML MCP config should be reviewed before syncing.", true),
				portable("Windsurf", "~/Library/Application Support/Windsurf/User/mcp.yml", "Windsurf user YAML MCP config should be reviewed before syncing.", true),
			},
		},
		{
			Name:        "VS Code",
			...
			Paths: []pathSpec{
				...
				portable("VS Code", "~/Library/Application Support/Code/User/mcp.yaml", "VS Code YAML MCP config should be reviewed before syncing.", true),
				portable("VS Code", "~/Library/Application Support/Code/User/mcp.yml", "VS Code YAML MCP config should be reviewed before syncing.", true),
		...
		},
		{
			...
			Paths: []pathSpec{
				...
				portable("Continue", "~/.continue/config.yml", "Continue config is potentially portable after provider, model, and path review.", true),
		...
		},
		{
			...
			Paths: []pathSpec{
				...
				portable("OpenCode", "~/.opencode.yaml", "OpenCode config is potentially portable after provider and path review.", true),
				portable("OpenCode", "~/.opencode.yml", "OpenCode config is potentially portable after provider and path review.", true),
				...
				portable("OpenCode", "~/.config/opencode/opencode.yaml", "OpenCode config is potentially portable after provider and path review.", true),
				portable("OpenCode", "~/.config/opencode/opencode.yml", "OpenCode config is potentially portable after provider and path review.", true),
		...
		},
		{
			...
			Paths: []pathSpec{
				...
				portable("Generic MCP", "~/.mcp.yaml", "Standalone YAML MCP config should be reviewed before syncing.", true),
				portable("Generic MCP", "~/.mcp.yml", "Standalone YAML MCP config should be reviewed before syncing.", true),
				portable("Generic MCP", "~/.config/mcp/mcp.json", "Standalone MCP config should be reviewed before syncing.", true),
				portable("Generic MCP", "~/.config/mcp/mcp.yaml", "Standalone YAML MCP config should be reviewed before syncing.", true),
				portable("Generic MCP", "~/.config/mcp/mcp.yml", "Standalone YAML MCP config should be reviewed before syncing.", true),
			},
		},
	}
}
	...
	return []adapterSpec{
		{
			...
			Paths: []pathSpec{
				...
				portable("Codex", ".codex/mcp.json", "Repo-local Codex MCP config should be reviewed before CI or dotfile sync.", true),
				portable("Codex", ".codex/mcp.yaml", "Repo-local Codex YAML MCP config should be reviewed before CI or dotfile sync.", true),
				portable("Codex", ".codex/mcp.yml", "Repo-local Codex YAML MCP config should be reviewed before CI or dotfile sync.", true),
		...
		},
		{
			...
			Paths: []pathSpec{
				...
				portable("Claude", ".claude/mcp.yaml", "Claude YAML MCP config should be reviewed before CI or dotfile sync.", true),
				portable("Claude", ".claude/mcp.yml", "Claude YAML MCP config should be reviewed before CI or dotfile sync.", true),
		...
		},
		{
			...
			Paths: []pathSpec{
				...
				portable("Cursor", ".cursor/mcp.yaml", "Cursor YAML MCP config should be reviewed before CI or dotfile sync.", true),
				portable("Cursor", ".cursor/mcp.yml", "Cursor YAML MCP config should be reviewed before CI or dotfile sync.", true),
		...
		},
		{
			...
			Paths: []pathSpec{
				...
				portable("VS Code", ".vscode/mcp.yaml", "VS Code YAML MCP config should be reviewed before CI or dotfile sync.", true),
				...
				portable("Windsurf", ".windsurf/mcp.yaml", "Windsurf YAML MCP config should be reviewed before CI or dotfile sync.", true),
				portable("Windsurf", ".windsurf/mcp.yml", "Windsurf YAML MCP config should be reviewed before CI or dotfile sync.", true),
				...
				portable("Continue", ".continue/config.yaml", "Continue config is portable after provider, model, and path review.", true),
				portable("Continue", ".continue/config.yml", "Continue config is portable after provider, model, and path review.", true),
				portable("OpenCode", ".opencode.json", "OpenCode config is portable after provider and path review.", true),
				portable("OpenCode", ".opencode.yaml", "OpenCode config is portable after provider and path review.", true),
				portable("OpenCode", ".opencode.yml", "OpenCode config is portable after provider and path review.", true),
				portable("OpenCode", "opencode.json", "OpenCode config is portable after provider and path review.", true),
				portable("OpenCode", "opencode.yaml", "OpenCode config is portable after provider and path review.", true),
				portable("OpenCode", "opencode.yml", "OpenCode config is portable after provider and path review.", true),
				portable("Generic MCP", ".mcp.json", "Standalone MCP config should be reviewed before CI or dotfile sync.", true),
				portable("Generic MCP", ".mcp.yaml", "Standalone YAML MCP config should be reviewed before CI or dotfile sync.", true),
				portable("Generic MCP", ".mcp.yml", "Standalone YAML MCP config should be reviewed before CI or dotfile sync.", true),
				portable("Generic MCP", "mcp.json", "Standalone MCP config should be reviewed before CI or dotfile sync.", true),
				portable("Generic MCP", "mcp.yaml", "Standalone YAML MCP config should be reviewed before CI or dotfile sync.", true),
				portable("Generic MCP", "mcp.yml", "Standalone YAML MCP config should be reviewed before CI or dotfile sync.", true),
			},
