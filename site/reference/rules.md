...
| `mcp_broad_filesystem` | medium | [docs](https://jsonbored.github.io/nightward/guide/mcp-security) | `narrow-filesystem` | MCP server can access a broad filesystem path |
...
| `mcp_server_review` | info | [docs](https://jsonbored.github.io/nightward/reference/rules) | `manual-review` | MCP server should be reviewed |
| `mcp_unknown_command` | info | [docs](https://jsonbored.github.io/nightward/reference/rules) | `manual-review` | MCP server has an unsupported command shape |
